    ...
    return (
        <div className="container-fluid ">
            <div className="row ">
                ...
                <h4 className="p-2 text-center text-black font-weight-bold">Recent Orders</h4>
                        ...
                        <tbody>
                            {details.map(x => (
                                <tr key={x.product.prodid}>
                                    ...
                                    <td><img className="mr-2 float-left" src={"http://localhost:5000/"+x.product.photo} width="100" />
                                    {x.product.pname}<br/>
